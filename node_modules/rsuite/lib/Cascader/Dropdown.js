...
function (_React$Component) {
  ...
  function Dropdown(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleSearchRowSelect", function (item, event) {
      ...
      var _getDerivedStateForCa = getDerivedStateForCascade(_this.props, _this.state, value),
  ...
  Dropdown.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (data !== prevState.data) {
      ...
      if (selectNodeValue) {
        ...
        return (0, _extends3.default)({}, getDerivedStateForCascade(nextProps, prevState, selectNodeValue, newChildren.map(function (item) {
      ...
      return (0, _extends3.default)({}, getDerivedStateForCascade(nextProps, prevState), {
        flattenData: (0, _treeUtils.flattenTree)(data),
        data: data
      });
    }
